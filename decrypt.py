...
# Decrpyt all the files with the same hash used to encrypt them
for file in filePaths:
    ...
    # Generate the key (hash generated by the same algorithim as the expected_hash, but with a different salt)
